...
public class SendMailUtil {
    ...
    public static boolean send(String to, String subject, String content) {
        ...
        props.put("mail.from", "me281026@163.com");
        if (true) {
        ...
        try {
            ...
            transport.connect("me281026", "mail0701");
            ...
            String nick="";
            try {
                nick=javax.mail.internet.MimeUtility.encodeText("System Message");
            } catch (UnsupportedEncodingException e) {
                e.printStackTrace();
            }
            message.setFrom(new InternetAddress("me281026@163.com"));
            //设置发信人
            ...
            //抄送人
            Address ccAddress = new InternetAddress("1152878184@qq.com");
    ...
    /*public static void main(String[] args) {
        ...
        //SendMailUtil.send("zww@app-tech.com", "抄送邮件发送", "抄送邮件发送测试.............");
    }*/
}